...
<main class="app-shell page-section">
    <section class="section-hero">
        ...
        <h1 class="form-title mt-3">Gestion de usuarios administradores</h1>
        <p class="form-subtitle">Crea nuevos administradores y controla si pueden iniciar sesion desde una pantalla unica.</p>
    </section>
    ...
    <section class="table-card">
        ...
        <form action="usuarios" method="post" class="user-form-grid">
            ...
            <div class="filter-actions">
                <button type="submit" class="app-button app-button-primary">Crear administrador</button>
            </div>
        </form>
    </section>
