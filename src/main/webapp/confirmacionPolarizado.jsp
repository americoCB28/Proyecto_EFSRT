...
<nav class="app-topbar">
    <div class="app-topbar-inner">
        <div class="brand-stack">
            ...
            <span class="brand-subtitle">La atencion de polarizado fue registrada correctamente</span>
        </div>
...
<main class="confirm-shell">
    <section class="confirm-card">
        ...
        <div class="stack-actions justify-content-center">
            <a href="inicio" class="app-button app-button-info">Volver al inicio</a>
